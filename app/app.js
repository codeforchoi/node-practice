...
const accessLogStream = require("./src/config/log"); // accessLogStream을 사용할 수 있도록 가져옴.
// 라우팅
...
app.use(morgan("dev"));                                 // 로그 관리 모듈 morgan 미들웨어 등록
app.use(morgan("common", { stream: accessLogStream })); // 로그 관리 모듈 morgan 미들웨어 등록
